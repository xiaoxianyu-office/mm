An ***automatically generated*** document that lists all the aitargets, grouped by tags/functionality.
...
Each aitarget can have more than one tag, and it is listed under each section for all the tags it has.

[[_TOC_]]

[>> Go to top](#)
## Untagged
These aitargets have not been tagged yet.
