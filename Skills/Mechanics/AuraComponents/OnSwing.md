## Description
Applies an aura component to the target that triggers a skill when they swing (left click)
...
ApplyAura:
  Skills:
  - aura{auraname=Ignite;d=300;i=1;components=[
    - onSwing{osw=CatchOnFire}
    ]} @self
CatchOnFire:
  Skills:
...
ApplyAura:
  Skills:
  - aura{auraname=Fireballs;d=300;i=1;components=[
    - onSwing{osw=ShootProjectile}
    ]} @self
ShootProjectile:
  Skills:
