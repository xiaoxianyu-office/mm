## Description
Applies an aura component to the target that triggers a skill when they place a block
...
ApplyAura:
  ...
  - aura{d=300;i=1;components=[
    - onBlockPlace{op=MidasTouch1;auraname=Golden} @self
    ]} @self
MidasTouch1:
  Skills:
...
ApplyAura:
  ...
  - aura{d=200;i=1;components=[
    - onBlockPlace{op=XRay;auraname=Cheater} @self
    ]} @self
XRay:
  Skills:
