...
| feardistance | fearrange, fdist, fd | When the affected entity's distance from the caster is less than this value, it will try to run *away* form it instead of completely randomly | 10.0f |
