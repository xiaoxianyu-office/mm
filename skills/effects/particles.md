...
| color | c | [(1)]("" "only works on colorable particle types like “reddust”")[(2)]("" "color must be provided in hex-code") The color of the particle The color of the particle |  |
| fromorigin |  |  | false |
