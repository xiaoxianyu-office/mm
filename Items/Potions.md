...
**&lt;type&gt;**  
Type of potion effect that should be applied. See below for a list of
...
**colors**  
The RGB color of the potion, i.e. **Color: 255,0,255** for a purple
potion

Potion Effects
--------------

This is a complete list of all potion effects currently useable by
